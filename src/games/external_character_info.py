class external_character_info:
    """_summary_
    """
    def __init__(self, name: str, is_generic_npc: bool, bio: str, ingame_voice_model: str, tts_voice_model: str, csv_in_game_voice_model: str, advanced_voice_model: str, voice_accent: str, tts_provider: str = "") -> None:
        ...
        self.__tts_provider: str = tts_provider
